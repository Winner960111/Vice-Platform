  ...
  return (
    <div className="relative w-full bg-back_color px-[254.24px] mt-28 z-30">
      ...
      <img
        src="moon-mask2.png"
        alt=""
        className="absolute bottom-[-150px] right-0 -z-10"
      />

      {/* Content */}
      <div className="flex flex-col items-center justify-center px-4 py-[190px] text-text_color z-0 max-w-[1600px]">
        <p className="w-[90%] text-center font-Space_Grotesk text-[48px] leading-tight">
          FUTURE OF DIGITAL WEALTH, POWERED BY $VICE
        </p>
        <p className="w-[90%] text-[14px] mt-4 text-center">
          Sign up to receive exclusive offers, road map updates, and upcoming
          giveaways.
        </p>
        <div className="flex mt-11 gap-1 flex-col lg:flex-row items-center">
          <input
            className="w-80 h-10 rounded-[10px] bg-[#3D3D3D] p-3"
