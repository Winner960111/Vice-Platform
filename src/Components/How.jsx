...
const Feature = () => {
  return (
    <div
      className="pt-[134px] pl-[100px] flex text-text_color justify-center bg-back_color"
      id="how"
    >
      <div className="flex max-w-[1600px] items-center justify-between lg:flex-row flex-col">
        <div className="space-y-[63px]">
          <p className="text-[48px] font-Space_Grotesk uppercase">
            How it works
          </p>
              ...
              <div className="flex items-start gap-[20px]">
                ...
                <div>
                  ...
                  <p className="text-[14px] mt-[12px] leading-tight w-[80%]">
                    Easily set up or enter decentralized raffles, and
                    sweepstakes with verifiable smart contracts.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-[20px]">
